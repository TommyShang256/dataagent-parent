...
public final class McpToolRegistry implements SmartInitializingSingleton {
    ...
    public void afterSingletonsInstantiated() {
        ...
        try {
            for (ToolRegistration registration : discovered.values()) {
                ...
                audit(registration, ToolAuditEvent.Operation.REGISTER, details(started, null, null, null));
            }
    ...
    private Object invoke(
        ...
        try {
            ...
            audit(registration, ToolAuditEvent.Operation.INVOKE, details(started, arguments, result, null));
            return result;
        } catch (Exception exception) {
            audit(registration, ToolAuditEvent.Operation.INVOKE, details(started, arguments, null, exception));
            throw exception;
        }
    }
